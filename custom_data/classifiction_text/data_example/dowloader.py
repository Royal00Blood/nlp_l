...
def downloader(links_data, last_name):
    ...
    train_data.to_csv(f"custom_data\classifiction_text\data_example\{last_name}_train.csv", index=False)
    test_data.to_csv (f"custom_data\classifiction_text\data_example\{last_name}_test.csv" , index=False)
...
downloader("legacy-datasets/banking77", "banking77")
